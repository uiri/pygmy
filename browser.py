...
class Browser:
    ...
    def addtab(self, widget=None, dummy=None, dummier=None, dummiest=None, openurl="http://google.com"):
        ...
        self.hbox[len(self.hbox)-1].pack_start(self.newtab[len(self.newtab)-1], False, True, 0)
        self.hbox[len(self.hbox)-1].pack_start(self.url_bar[len(self.url_bar)-1], True, True, 2)
        self.hbox[len(self.hbox)-1].pack_end(self.closetab[len(self.closetab)-1], False, True, 0)
